      ...
      <div className="min-h-full">
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col lg:border-r lg:border-gray-200 lg:bg-gray-100 lg:pt-5 lg:pb-4">
          ...
          <div className="mt-6 flex h-0 flex-1 flex-col overflow-y-auto">
            ...
            <Menu
              as="div"
              className="relative inline-block px-3 text-left mt-1"
            >
              <div>
                <Menu.Button className="group w-full rounded-md bg-gray-100 px-3.5 py-2 text-left text-sm font-medium text-gray-700 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-gray-100">
            ...
            <div className="mt-5 px-3">
              ...
              <div className="relative mt-1 rounded-md shadow-sm">
                ...
                <input
                  ...
                  id="search"
                  style={{ height: '50px' }}
                  className="block w-full rounded-md border-gray-300 pl-9 h-5 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                  placeholder="Search"
                />
              </div>
            </div>
            ...
            <div className="border-b border-gray-200 px-4 py-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8">
              ...
              <div className="mt-4 flex sm:mt-0 sm:ml-4">
                ...
                <button
                  ...
                  type="button"
                  className="order-0 inline-flex items-center rounded-md border border-transparent bg-black px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 sm:order-1 sm:ml-3"
                >
                  Logout
                </button>
              </div>
                  ...
                  >
                    ...
                    <div className="flex flex-1 items-center justify-between truncate rounded-r-md border-t border-r border-b border-gray-200 bg-white">
                      ...
                      <Menu as="div" className="flex-shrink-0 pr-2">
                        <Menu.Button className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-white text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">
